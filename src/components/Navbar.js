          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                <div>
                  <input type = "text" className = "rounded-full py-1 px-1 text-black dark:text-black-dark border-white" placeholder = "Zipcode"></input>
                </div>
                  <div className = "signin ">
                      <a href = "#" className = "text-white font-verdana no-underline hover:underline rounded-md px-3 py-2 text-xl">Sign In</a>
                  </div>
